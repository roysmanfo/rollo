...
export default function LoginPage() {
  ...
  const onSend = async (event: GestureResponderEvent) => {
    ...
    if (!nome) {
      setErrorMsg('Nome mancante');
      setIsLoading(false);
      return;
    }

    if (!cognome) {
      setErrorMsg('Cognome mancante');
      setIsLoading(false);
      return;
    }
    ...
    const res = await authSignUp(nome, cognome, email, password);
  ...
  return (
    <SafeUIView style={{ backgroundColor: '#0a0a0a', padding: 30, isolation: 'isolate' }}>
      ...
      <View style={styles.inputContainer}>
        ...
        <Text style={{ color: styles.input.color, fontFamily: 'Montserrat' }}>Nome</Text>
        <TextInput
          style={styles.input}
          placeholder="Nome"
        ...
        />
        <Text style={{ color: styles.input.color, fontFamily: 'Montserrat' }}>Cognome</Text>
        <TextInput
          style={styles.input}
          placeholder="Cognome"
          placeholderTextColor={styles.input.color}
